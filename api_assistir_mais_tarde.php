...
if ($acao === 'adicionar') {
    $resultado = inserirAssistirMaisTarde($idUsuario, $idTmdb);
} else {
    $resultado = removerAssistirMaisTarde($idUsuario, $idTmdb);
}

if ($resultado['sucesso']) {
    echo json_encode(['sucesso' => true, 'assistirMaisTarde' => $acao === 'adicionar']);
} else {
